...
#CheckEven = lambda no : (no % 2==0)              #checking even odd without if-else 
...
def main():
    ...
    reduce_output = reduce(lambda A, B :  (A + B), map_output)         #directly giving lambda function to filter which makes lambda anonymous
